...
var url = require('url');
var debugLogging = require('util').debuglog('air');
...
function fetchStations(callback) {
  var urlObject = url.parse('http://data.goteborg.se/AirQualityService/v1.0/LatestMeasurement/' + config.key +'?format=json');
